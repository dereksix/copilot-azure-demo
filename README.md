...
| Frontend Web App | `app-frontend-89609` | User-facing web interface |
| Backend API App | `app-backend-89609` | REST API with SQL connectivity |
| SQL Server | `sql-copilot-demo-89609` | Azure SQL logical server (Azure AD auth) |
| SQL Database | `appdb` | Application database (Basic tier) |
| Application Insights | `ai-copilot-demo` | Monitoring and tracing |
| Storage Account | `stcopilot89609` | Logs and diagnostics |

### Live URLs

- **Frontend**: https://app-frontend-89609.azurewebsites.net
- **Backend API**: https://app-backend-89609.azurewebsites.net
- **SQL Server**: sql-copilot-demo-89609.database.windows.net
